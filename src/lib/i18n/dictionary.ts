...
export const RULES: Record<Lang, string[]> = {
  ar: [
    ...
    "إذا التعادل عند 10-10، تبدأ جولة فاصلة (ديسايدر) من 0-0، وأول لاعب يتقدم بفارق نقطتين يفوز الشوط.",
    ...
    "الفوز بالغياب أو الانسحاب ما له فارق نقاط يتقاس، فيتحسب فوز بنقطة وحدة وما ينخصم من الخاسر شي.",
    " يمنع استعمال إرسال أبو ملوك في الادوار الاقصائية فقط⚡.",
  ...
  en: [
    ...
    "At 10-10 a decider begins from 0-0, and the first player to lead by two points takes the game.",
    ...
    "A win by absence or withdrawal has no margin to measure, so it counts as a 1-point win and the loser is docked nothing.",
