...
export const dict = {
  ar: {
    ...
    prize: {
      title: "جوائز البطل",
      lede: "جائزتين، وكلها للبطل وحده. الثاني ما له إلا الحسرة، والثالث يلعب على الشرف.",
      fundedBy: "بتمويل من",
      forChampion: "للمركز الأول",
      kleeja: "كرتون كليجا",
      kleejaNote: "الجائزة الأصلية، تنسلّم باليد يوم النهائي.",
      claude: "اشتراك كلود",
  ...
  en: {
    ...
    prize: {
      title: "The champion's prizes",
      lede: "Two prizes, both of them the champion's alone. Second place gets condolences, third place gets played for.",
      fundedBy: "Funded by",
      forChampion: "First place",
      kleeja: "A box of kleeja",
      kleejaNote: "The original prize, handed over on finals day.",
      claude: "A Claude subscription",
